...
<section style="padding-top: 30px;">
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <nav aria-label="breadcrumb bg-transparent">
                    <ol class="breadcrumb bg-transparent">
                        ...
                        <li class="breadcrumb-item"><a href="/genshin-impact">Genshin Impact</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                <div class="card-body">
                                    ...
                                    <a style="color: black;" href="/genshin-impact/{{$pre->type}}/{{$pre->url}}"><h4 style="font-size: 1.2em;" class="card-title">{{$pre->judul}}</h4></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                <div class="card-body">
                                    ...
                                    {{-- <a style="color: black;" href="{{$artikel->type}}"><span id="label">#{{$artikel->type}}</span><br></a> --}}
                                    <a style="color: black;" href="/genshin-impact/{{$next->type}}/{{$next->url}}"><h4 style="font-size: 1.2em;" class="card-title">{{$next->judul}}</h4></a>
                                    <div><img width="40" height="40" src="{{ asset('assets/person-icon.png') }}" alt="javabow author"> <span style="font-size: 0.9em;" id="author-name">Hilmi Farhandika</span></div>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach($komentar as $comments)
                        <div class="col-md-12">
                            <div class="media g-mb-30 media-comment">
                                <img class="d-flex g-width-50 g-height-50 rounded-circle g-mt-3 g-mr-15" src="{{ asset('assets/person-icon.png') }}" alt="Comments Avatar">
                                <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30">
                                <div class="g-mb-15">
                                    <h5 class="h5 g-color-gray-dark-v1 mb-0">{{$comments->nama}}</h5>
                                    <span class="g-color-gray-dark-v4 g-font-size-12">{{$comments->created_at->format('F Y')}}</span>
                                </div>
            ...
            <div class="col-md-8 offset-md-2">
                <hr class="my-4">
                <form method="post" action="/komentar/post" enctype="multipart/form-data">
                    {{ csrf_field() }}
