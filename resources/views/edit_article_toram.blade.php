@include('layouts.header')
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-9">
                            <form method="post" action="{{ URL::to('/dashboard/update') }}/{{ $data->id_artikel }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul" class="form-control" value="{{ $data->judul }}" placeholder="Judul Artikel">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="content" id="description-textarea" rows="8">{{ $data->isi }}</textarea>
                        ...
                        <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select name="page" class="form-control" required>
                                        ...
                                        <option value="service" {{ $data->page == 'service' ? "selected":"" }}>Service</option>
                                        <option value="project" {{ $data->page == 'project' ? "selected":"" }}>Project</option>
                                        <option value="artikel" {{ $data->page == 'artikel' ? "selected":"" }}>Artikel</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="label" class="form-control" required>
                                        ...
                                        <option value='{{ $lable->id_label }}' {{ $data->type == $lable->id_label ? "selected":"" }}>{{ $lable->nama_label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label><b>Tag</b></label>
                                    <input type="text" id="tag-artikel" style="width: 300px;" name="tag" value="" placeholder="Tag Artikel">
                                ...
                                <div class="form-group">
                                    ...
                                    <p>Please select an image to be the main picture of this article</p>
                                    <input name="thumbnail" value="{{ $data->image }}" type="hidden" id="thumbnail">
                                    <a href="{{ URL::to('/laravel-filemanager') }}?type=images" id="feature-img-container"><img width="300" height="300" src="{{ $data->image }}"></a>
                                </div>
                                <div class="form-group">
                                    <label><b>Header Page Image</b></label>
                                    <p>Please select an image to be the Header picture of this article</p>
                                    <input name="header_thumbnail" value="{{ $data->header_image }}" type="hidden" id="header_thumbnail">
                                    <a href="{{ URL::to('/laravel-filemanager') }}?type=images" id="feature-img-container-2"><img width="300" height="300" src="{{ $data->header_image }}"></a>
                                </div>
